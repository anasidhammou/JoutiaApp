...
public class ConnectedObjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connected_object);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    for (int i = 0; i < allproductarray.size(); i++) {
                        if(allproductarray.get(i).Catégorie.equals("Objets connectés")
                                && allproductarray.get(i).Approuved.equals(true)
                                && allproductarray.get(i).State.equals("1")){
    ...
    private void initialiserecyclerdfilter(List<product> allproductarrayfiltred,ArrayList<ArrayList<String>> arrayList) {
        ...
        adapter.setOnDataChangeListener(new CustomGridAdapterView.OnDataChangeListener() {
            ...
            public void showDetail(Object object) {
                Intent i =new Intent(ConnectedObjectActivity.this, DetailsTypeProductActivity.class);
                i.putExtra("Nom",object.toString());
                i.putExtra("type", "Objets connectés");
                startActivity(i);
            }
        });
    }
